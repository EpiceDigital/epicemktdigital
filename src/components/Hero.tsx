      ...
      <div className="container mx-auto z-10 text-center">
        ...
        <div className="absolute bottom-0 left-0 right-0 flex items-center justify-center z-0 translate-y-1/2">
          <img
            src={infinito}
            alt="Infinito"
            className="w-full max-w-5xl opacity-10 drop-shadow-[0_0_40px_rgba(255,255,255,0.4)] -rotate-[20deg]"
          />
        </div>
        ...
        <div className="flex justify-center animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 px-4">
          <Button 
            variant="hero" 
            size="lg" 
            className="uppercase font-bold text-sm md:text-base lg:text-lg px-6 md:px-8 py-5 md:py-6 rounded-lg w-full md:w-auto max-w-md"
